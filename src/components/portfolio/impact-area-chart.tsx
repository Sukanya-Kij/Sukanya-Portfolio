...
export function ImpactAreaChart() {
    ...
    if (chartWidth === 0) {
        return (
            <div ref={containerRef} className="h-64 w-full min-w-0 animate-pulse rounded-2xl border border-emerald-100/50 bg-gradient-to-tr from-emerald-50/50 to-emerald-100/20 flex flex-col justify-center gap-3 px-8">
